...
#当你看到这里的时候，你就该知道我写的有多烂了
#又得地方我自己可能都记不住改了，因为我是后写的注释www
init offset = -1
...
screen quick_menu():
    #这里我做了大改，只保留了save load auto skip的四个imagebutton
    #其实我应该再加个selected，但是先偷懒一会（
    ## 确保该菜单出现在其他屏幕之上，
    zorder 100
    ...
    if quick_menu:
        ...
        hbox:
            ...
            spacing 200
            imagebutton:
                    idle "images/mainmenu/save_btn_idle.png"   # 按钮未按下时的图片
                    hover "images/mainmenu/save_btn_hover.png" # 鼠标悬停时的图片
                    selected_idle "images/mainmenu/save_btn_hover.png"
                    selected_hover "images/mainmenu/save_btn_idle.png"
                    anchor (0.5, 0.5)
                    action ShowMenu("save")
                    hover_sound "audio/hover.wav"
            imagebutton:
                    idle "images/mainmenu/ld_btn_idle.png"   # 按钮未按下时的图片
                    hover "images/mainmenu/ld_btn_hover.png" # 鼠标悬停时的图片
                    selected_idle "images/mainmenu/ld_btn_hover.png"
                    selected_hover "images/mainmenu/ld_btn_idle.png"
                    anchor (0.5, 0.5)
                    action ShowMenu("load")
                    hover_sound "audio/hover.wav"
            imagebutton:
                    idle "images/mainmenu/auto_btn_idle.png" #if not AutoForward() else "images/mainmenu/auto_btn_hover.png"
                    hover "images/mainmenu/auto_btn_hover.png" #if not AutoForward() else "images/mainmenu/auto_btn_idle.png"
                    selected_idle "images/mainmenu/auto_btn_hover.png"
                    selected_hover "images/mainmenu/auto_btn_idle.png"
                    anchor(0.5,0.5)
                    action Preference("auto-forward", "toggle")
                    hover_sound "audio/hover.png"
            imagebutton:
                    idle "images/mainmenu/skip_btn_idle.png"
                    hover "images/mainmenu/skip_btn_hover.png"
                    selected_idle "images/mainmenu/skip_btn_hover.png"
                    selected_hover "images/mainmenu/skip_btn_idle.png"
                    anchor(0.5,0.5)
...
screen navigation():
    ...
    #pass掉了，理论上删除了所有调用navigation的途径
...
screen file_slots(title):
        ...
        grid 3 2:
            ...
            for i in range(6):
                ...
                button:
                    ...
                    has vbox
                    frame:
                        background Frame("gui/slot.png")
                        xysize(400,225)
                        add FileScreenshot(slot):
                            xysize(400,225)
                            align(0.5,0.5)
                    text FileTime(slot,format=_("{#file_time}%Y-%m-%d %H:%M")) style "slot_time_text" size 20
                    text FileTime(slot,format=_("[slot]"),empty=_("[slot]")) style "slot_time_text" size 30
    ...
    hbox:
            ...
            if not main_menu :
                imagebutton:
                    ...
                    pos(1636,800)
                    anchor(0.5,0.5)
                    idle "images/mainmenu/menu_idle.png"
                    hover "images/mainmenu/menu_hover.png"
                    action MainMenu()
    ...
    vbox:
        ...
        hbox:
            ...
            textbutton _(">"):
                    action FilePageNext(max=3,wrap=False)
...
#     use game_menu(_(""), scroll=("vpgrid" if gui.history_height else "viewport"), yinitial=1.0, spacing=20):
