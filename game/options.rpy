...
define config.name = _("nkb_tongren")

define config.quit_action = Show("quitscreen")#点右上角渐黑退出
...
define config.main_menu_music = "title.wav"
...
define config.save_directory = "nkb_tongren-1750124162"
